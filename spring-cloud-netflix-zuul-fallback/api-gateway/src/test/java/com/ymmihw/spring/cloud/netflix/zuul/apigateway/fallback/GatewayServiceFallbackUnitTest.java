package com.ymmihw.spring.cloud.netflix.zuul.apigateway.fallback;
...
import com.ymmihw.spring.cloud.netflix.zuul.apigateway.fallback.GatewayServiceFallback;
...
public class GatewayServiceFallbackUnitTest {
  ...
  @Test
  public void testFallbackResponse_whenNonHystrixException_thenInternalServerError()
      throws Exception {
