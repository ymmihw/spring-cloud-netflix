package com.ymmihw.spring.cloud.netflix.archaius.controller;
...
public class ConfigPropertiesController {
  ...
  private DynamicIntProperty intPropertyWithDynamic =
      DynamicPropertyFactory.getInstance().getIntProperty("baeldung.archaius.properties.int", 0);
